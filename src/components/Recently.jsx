    ...
    const fetchData = async () => {
      try {
        if (!token) {
          ...
          const response = await fetch(`${import.meta.env.VITE_API_TOP_MIX}browse/categories/0JQ5DAqbMKFQ00XGBls6ym/playlists`, 
          {
            method: "GET",
            headers: {
  ...
  return (
    <div className="w-[96%] mx-auto pt-4">
      <div className="flex justify-between w-full my-4">
        <h2 className="text-white font-semibold text-2xl">RECENT PLAYED</h2>
