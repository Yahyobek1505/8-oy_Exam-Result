...
const Recently = () => {
  ...
  useEffect(() =>{
    setIsloading(true)
  if (token) {
    fetch(`${import.meta.env.VITE_API_TOP_MIX}browse/categories/0JQ5DAqbMKFQ00XGBls6ym/playlists`, {
      method: "GET",
      headers:{
...
<h2 className='text-white font-semibold text-2xl'>Recently played</h2>
